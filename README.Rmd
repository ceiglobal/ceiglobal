...
badge_travis("ceiglobal/ceiglobal")
badge_last_commit("ceiglobal/ceiglobal")
badge_custom("Most used package", "in CEI", "green")
badge_codecov("ceiglobal/ceiglobal")
badge_cran_checks("ceiglobal/ceiglobal")
```
<!-- badges: end -->
